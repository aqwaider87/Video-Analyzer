    ...
    <div className={`relative ${rtl ? 'font-arabic' : 'font-english'} select-none`}>
      <div className="space-y-6">
        <div className="space-y-3">
          <AnimatedHeading
            className="font-extrabold tracking-tight text-[clamp(2.5rem,4vw,3.25rem)] leading-[1.06] text-[var(--text-strong)] relative"
            phrase={t.title}
          />
        </div>
        <motion.p
          ...
          className="relative pl-5 md:pl-6 text-[15px] md:text-[16.5px] leading-relaxed max-w-md font-normal tracking-[0.005em] text-[var(--text-muted)]/95 [text-wrap:balance]"
        >
          <span className="absolute left-0 top-2.5 w-2 h-2 rounded-full bg-[var(--text-muted)]/55 shadow-sm"></span>
          {t.subtitle}
        </motion.p>
